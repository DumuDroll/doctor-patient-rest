...
class FullInfoMockitoTest {
	...
	void fullInfosGetAll() {
		FullInfo fullInfo1 = new FullInfo(1L, null, "",
				"", null);
		FullInfo fullInfo2 = new FullInfo(2L, null, "",
				"", null);
	...
	void fullInfosPost() {
		long id = 1L;
		FullInfo fullInfo = new FullInfo(id, null, "",
				"", null);
		FullInfoDto expectedFullInfoDto = new FullInfoDto(id, null, "",
				"");
	...
	void fullInfosPut() {
		long id = 2L;
		FullInfo oldFullInfo = new FullInfo(id, null, "",
				"", null);
		FullInfo newFullInfo = new FullInfo(id, null, "2",
				"", null);
		FullInfoDto expectedFullInfoDto = new FullInfoDto(id, null, "2",
				"");
